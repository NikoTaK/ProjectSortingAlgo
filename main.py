...
def draw(draw_info, algo_name, ascending):
	...
	controls = draw_info.FONT.render("R - Reset | SPACE - Start Sorting | A - Ascending | D - Descending", 1, draw_info.BACK)
	draw_info.window.blit(controls, (draw_info.width/2 - controls.get_width()/2 , 55))

	sorting = draw_info.FONT.render("I - Insertion Sort | B - Bubble Sort | M - Merge Sort | H - Heap Sort ", 1, draw_info.BACK)
	draw_info.window.blit(sorting, (draw_info.width / 2 - sorting.get_width() / 2, 85))

	sorting = draw_info.FONT.render("Q - Quick Sort  | L - Shell Sort", 1, draw_info.BACK)
